...
public class LoopManiaApplication extends Application {
    ...
    // private LoopManiaWorldController mainControllerBersek;
    private FXMLLoader gameLoader;
    private Parent gameRoot;
    private LoopManiaWorld loopManiaWorld;
    // private LoopManiaWorldController mainControllerSurvival;
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        loopManiaWorld = loopManiaLoader.getWorld();
        ...
        FXMLLoader modeLoader = new FXMLLoader(getClass().getResource("GameMode.fxml"));
        modeLoader.setController(gameModeController);
        Parent gameModeRoot = modeLoader.load();
